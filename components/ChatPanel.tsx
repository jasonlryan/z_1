...
export function ChatPanel({ messages, onSend, isLoading = false, className }: ChatPanelProps) {
...
export function ChatPanelDemo() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "Hello! How can I help you with Zeno Knows today?",
      sender: "assistant",
      timestamp: new Date(),
    },
  ])
  ...
  const handleSend = (message: string) => {
    ...
    setTimeout(() => {
      const aiMessage: Message = {
        ...
        content: `I understand you're asking about: **${message}**. Let me help you find the right tools and resources.`,
        sender: "assistant",
        timestamp: new Date(),
      }
