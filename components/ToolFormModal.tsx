...
export function ToolFormModal({ isOpen, onClose, onSave, tool, className }: ToolFormModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">{tool ? "Edit Tool" : "Add New Tool"}</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center">
            ...
            />
            <label className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Featured tool</label>
          </div>
